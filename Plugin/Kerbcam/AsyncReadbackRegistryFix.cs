...
// any time a kerbcam RenderTexture has been destroyed (camera disposal,
...
namespace Kerbcam
{
    ...
    {
        private const string HarmonyId = "kerbcam.asyncreadback.cleardeadrefs";
        ...
        private void Awake()
        {
            ...
            {
                Debug.LogError($"[Kerbcam-ReadbackFix] failed to apply Harmony patch: {ex}");
            }
        }
        ...
        private static void ApplyPatch()
        {
            ...
            {
                Debug.LogWarning("[Kerbcam-ReadbackFix] RenderTextureRegistery type not found; skipping patch");
                return;
            }
            ...
            if (method == null)
            {
                Debug.LogWarning("[Kerbcam-ReadbackFix] ClearDeadRefs not found; skipping patch");
                return;
            }
            ...
            Debug.Log("[Kerbcam-ReadbackFix] patched RenderTextureRegistery.ClearDeadRefs");
        }
    ...
    internal static class ClearDeadRefsPatch
    {
        ...
        public static bool Prefix()
        {
            ...
            {
                Debug.LogError($"[Kerbcam-ReadbackFix] prefix threw; falling back to original: {ex}");
                return true;
            }
        }
